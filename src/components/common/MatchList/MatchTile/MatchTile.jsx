...
const MatchTile = ({ id, players: { team1, team2 }, date }) => (
  <li
    key={id}
    className="flex flex-col align-middle w-full max-w-4xl rounded-lg p-3 drop-shadow-sm relative bg-gradient-to-b from-slate-700 to-slate-800 overflow-hidden"
  >
